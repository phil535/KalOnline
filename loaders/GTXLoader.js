...
THREE.GTXLoader = function () {
	this._parser = THREE.GTXLoader.parse;
};

THREE.GTXLoader.prototype = Object.create( THREE.CompressedTextureLoader.prototype );
THREE.GTXLoader.prototype.constructor = THREE.GTXLoader;

THREE.GTXLoader.parse = function ( buffer, loadMipmaps ) {
