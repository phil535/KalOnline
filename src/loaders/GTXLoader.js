...
export default class GTXLoader extends THREE.CompressedTextureLoader {
	...
	parse (buffer, loadMipmaps) {
		...
		var header = Array.from(new Int32Array( buffer, 0, headerLengthInt ));
